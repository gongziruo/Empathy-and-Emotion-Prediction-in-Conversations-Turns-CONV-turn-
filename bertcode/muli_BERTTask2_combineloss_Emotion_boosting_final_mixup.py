...
if  result > 0.73:
    ...
    # 保存为 TSV 文件
    logits_df_test.to_csv('boosting_bert_Emotion'+str(result)+'total_test_preds.csv', sep='\t', index=False)
    print("total_test_preds have been saved to Emotion"+str(result)+'total_preds.csv')
